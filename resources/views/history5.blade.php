    ...
    <div class="flex flex-col lg:flex-row"> 
        <div class="max-w-2xl w-full lg:w-1/2 mx-auto mb-4 lg:mb-0"> 
            <div class="p-5 border border-gray-300 rounded-lg relative">
                ...
                <iframe style="border-radius:12px" src="https://open.spotify.com/embed/album/5U4dnRZsfW8NmwBBkELFPh?utm_source=generator" width="100%" height="152" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe></div>
        </div>
...
A atmosfera durante as gravações foi caótica, com os membros da banda muitas vezes vivendo em meio a drogas, festas e tumultos. No entanto, essa tumultuada experiência contribuiu para a sonoridade distintiva e crua do álbum. O produtor Jimmy Miller foi fundamental no processo de gravação, embora tenha enfrentado desafios para equilibrar a criatividade da banda com o ambiente caótico.

"Exile on Main St." abrange uma ampla gama de estilos musicais, incluindo rock and roll, blues, country, gospel e soul. A diversidade de influências reflete a riqueza cultural da música americana. Algumas das faixas mais conhecidas incluem "Tumbling Dice", "Happy", "All Down the Line" e "Rocks Off".
