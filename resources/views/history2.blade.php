    ...
    <div class="flex flex-col lg:flex-row"> 
        <div class="max-w-2xl w-full lg:w-1/2 mx-auto mb-4 lg:mb-0"> 
            <div class="p-5 border border-gray-300 rounded-lg relative">
                ...
                <iframe style="border-radius:12px" src="https://open.spotify.com/embed/album/4LH4d3cOWNNsVw41Gqt2kv?utm_source=generator" width="100%" height="152" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe></div>
        </div>
        ...
        <div class="max-w-2xl w-full lg:w-1/2 mx-auto mb-4 lg:mb-0"> 
            <div class="p-5 border border-gray-300 rounded-lg w-full h-full">
                ...
                O álbum foi gravado no estúdio Abbey Road, em Londres, e foi produzido por Pink Floyd, com Alan Parsons atuando como engenheiro de som. O processo de gravação foi inovador para a época, com a banda experimentando extensivamente com técnicas de estúdio, como o uso de sintetizadores, efeitos sonoros e gravação multicanal. O produtor Alan Parsons desempenhou um papel fundamental na realização da visão sonora do álbum.

                Lançado em 1973, "The Dark Side of the Moon" tornou-se um enorme sucesso comercial e crítico. Ele permaneceu na parada de álbuns da Billboard por mais de 900 semanas consecutivas e é um dos álbuns mais vendidos de todos os tempos. A capa do álbum, projetada por Storm Thorgerson e a empresa Hipgnosis, apresenta o famoso prisma triangular refratando a luz, criando um espectro de cores. A capa é icônica e se tornou um símbolo associado ao álbum.
